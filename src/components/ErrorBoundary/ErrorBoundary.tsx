    ...
    if (this.state.hasError) {
      ...
      return (
        <main className='flex h-screen w-full flex-col items-center justify-center'>
          ...
          <div className='bg-primary absolute rotate-12 rounded px-2 text-sm text-white'>Error!</div>
          <button className='mt-5'>
            ...
            >
              <span className='bg-primary absolute inset-0 translate-x-0.5 translate-y-0.5 transition-transform group-hover:translate-x-0 group-hover:translate-y-0' />
